  ...
  return (
    <div className="space-y-10">
      <PageHeader
        ...
        description="Onay kuyruğu, kategoriler, KVKK moderasyonu (R2–R4)."
        actions={
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <SectionCard
          title="Üye yönetimi"
          description="Tüm kayıtlı kullanıcıları ve platform rollerini görün."
        >
          <Link
        ...
        <SectionCard
          ...
          description="Firma oluşturun, sahip atayın veya e-posta ile davet edin."
        >
          <Link
...
function Queue({
  ...
  if (!items.length) {
    return (
      <p className="rounded-2xl border border-dashed border-brand-200 bg-brand-50/30 px-4 py-6 text-sm text-slate-500">
        {empty}
      </p>
    );
  }
